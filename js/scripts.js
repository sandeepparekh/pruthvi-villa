...
---------------------------------------------------*/
	...
	function PageLoad() {	
		...
		setTimeout(function(){
			$('drft4').append('<span class="hold-progress-bar"></span>');
			$('body').append('<audio loop autoplay volume="0" id="audio"><source src="https://www.chosic.com/wp-content/uploads/2021/04/plasterbrain__loop-by-the-sea(chosic.com).mp3" type="audio/mpeg" /></audio>');
